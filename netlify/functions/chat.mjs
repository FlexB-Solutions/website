...
const WEBSITE_KNOWLEDGE = [
  ...
  'Machine Learning umfasst Mustererkennung, Vorhersagen, Anomalieerkennung und Objekterkennung. Technisch Python, passende Bibliotheken und KNIME. Entwicklung strukturiert nach CRISP-ML(Q), der AI Act wird mitgedacht.',
  ...
  'Produktfertigung umfasst zwei Punkte: Prototypen & Individualanfertigungen sowie Kleinserien. Gedruckt wird auf Bambu Lab. Ablauf: Anforderung, parametrische Konstruktion im CAD, Abstimmung, Slicing und Druck, Pruefung am realen Einbauort.',
